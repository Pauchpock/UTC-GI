...
\fancypagestyle{plain}{
    % Headers
    \fancyhead[R]{Rapport TP4 SY31}
    \fancyhead[L]{Romain \textsc{PELLERIN} - Kyâne \textsc{PICHOU} - Nianfei \textsc{SHI}}
...
\title{Rapport SY31}
\author{Romain PELLERIN, Kyâne PICHOU et Nianfei SHI}
\date\today
...
\begin{center}
    ...
    \presentationLarge{\Huge{4 - Détection d'objets par Lidar}}
\end{center}
\end{minipage}}
\vspace{3cm}
...
\hline
    \multicolumn{2}{|c|}{Romain \textsc{PELLERIN} - Kyâne \textsc{PICHOU} - Nianfei \textsc{SHI}}\\
\hline
